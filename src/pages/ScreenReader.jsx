                                ...
                                <table className="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="http://www.nvda-project.org/" target='_blank' rel="noopener" title="External site that opens in a new window">http://www.nvda-project.org/</a>
                                                <br />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="http://www.satogo.com/" target="_blank" rel="noopener" title="External site that opens in a new window">http://www.satogo.com/</a><br />(External website that opens in a new window)
                                            </td>
                                            <td>Free</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Web Anywhere</td>
                                            <td>
                                                <a href="http://webanywhere.cs.washington.edu/wa.php" target="_BLANK" rel="noopener" title="External site that opens in a new window">http://webanywhere.cs.washington.edu/wa.php</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>Hal</td>
                                            <td>
                                                <a href="http://www.yourdolphin.co.uk/productdetail.asp?id=5" target="_BLANK" rel="noopener" title="External site that opens in a new window">http://www.yourdolphin.co.uk/productdetail.asp?id=5</a>
                                                <br />(External website that opens in a new window)
                                            </td>
                                            <td>Commercial</td>
                                        </tr>
