...
export default function StudentsPerformanceReport() {
    ...
    return data.reduce((acc, curr) => {
      ...
      if (group) {
        ...
        group.functional_toilet_girls_percent=parseFloat(((group.tot_school_girl_co_ed*100)/group.total_no_of_fun_toilet)).toFixed(2);
        group.sch_having_toilet_40_percent=parseFloat(((group.toilet_40*100)/group.tot_school_girl_co_ed)).toFixed(2)
        ...
        acc.push({
          ...
          functional_toilet_girls_percent:parseFloat((curr.tot_school_girl_co_ed*100)/curr.total_no_of_fun_toilet).toFixed(2),
          sch_having_toilet_40_percent:parseFloat(((curr.toilet_40*100)/curr.tot_school_girl_co_ed)).toFixed(2),
