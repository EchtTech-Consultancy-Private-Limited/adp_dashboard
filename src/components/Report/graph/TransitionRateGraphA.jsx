...
export default function TransitionRateGraphA() {
  ...
  const {
    ...
    boysData: topBoysData,
    girlsData: topGirlsData,
  } = getChartData(TopDistricts || []);
  const { categories, boysData, girlsData } = getChartData(
    AllDistricts?.slice(
    ...
    <div className="col-md-12">
      <div className="graph-card">
        <h4 className="heading-sm">
          Year Wise {selectReportType === "ADP_Report" ? "District" : "Block"}{" "}
          Transition Rate
        </h4>
        <div className="graph">
          <HighchartsReact
            ...
            options={chartOptions(
              ...
              boysData,
              girlsData,
              "Year Wise District Transition Rate"
            )}
            immutable={true}
          />
        </div>
